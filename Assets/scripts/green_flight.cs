...
public class green_flight : MonoBehaviour, IPointerClickHandler
{
    void Start()
    {
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(txt.text.Equals("Select all blocks that are green OR have flight") && pk2.enabled==false && pk1.enabled==false)
        {
            txt.text = "You win!";
            pk3.enabled = false;
