...
public class purple_strength_1 : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(txt.text.Equals("Select all blocks that are purple AND have strength") && pk2.enabled==false)
        {
