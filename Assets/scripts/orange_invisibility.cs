...
public class orange_invisibility : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(txt.text.Equals("Select all blocks that are purple OR have invisibility") && pk1.enabled==false)
        {
